...
/**
 * Generated class for the FourswitchonesliderandschedularPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-fourswitchonesliderandschedular',
  templateUrl: 'fourswitchonesliderandschedular.html',
})
export class FourswitchonesliderandschedularPage {
